        ...
        <div className="content-split">
          ...
          <div className="right-col">
            ...
            <div className="panel simulator-container" style={{ marginTop: '1.5rem', borderLeft: '4px solid var(--accent-color)' }}>
              ...
              <div className="simulator-form" style={{ display: 'flex', gap: '1rem' }}>
                ...
                <button className="btn-simulate" onClick={async () => {
                  ...
                  try {
                    ...
                    alert(`🔮 Predicted Demand: ${res.data.predicted_kwh} kWh\n🌡️ Est. Temp: ${res.data.estimated_temp}°C\n💡 Rec: ${res.data.recommendations.join(', ')}`);
